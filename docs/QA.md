...
- Reviewed 14 additional records against full employer/LinkedIn descriptions, including one separately verified Capgemini Supply Planning Specialist. Dataset: 30 records, 20 scored, 17 active scored recommendations; six closed, six unscored pending descriptions, one possible HP duplicate held. A failed fetch is not treated as closure.
- Confirmed closed/expired: Be Verse Demand Supply Planner, Capgemini Demand Planner, Hired Procurement Specialist, Hired Supply Chain Manager (expired-listing redirect), and Vestas Inventory Count Analyst (10 September deadline). Ford was already closed.
...
- Local browser checks at 390×844 and 1280×900: 17/17 active cards have scores and loaded company images, no horizontal overflow; mobile detail and weighted breakdown verified; no console warnings/errors. Sources exposes the six specific unscored limitations. Target salary banner removed from job headers as previously requested.
